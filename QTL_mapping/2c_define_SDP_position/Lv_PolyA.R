...
locals_unknowns = QTL_cat_test(eQTL_results_Lv_polyA, ids_unknown[start:end], local_sdps)
save(locals_unknowns, file =  paste(dir, "20180213_Lv_polyA/unknowns_", counter, ".RData", sep=""))
