...
locals_unknowns = QTL_cat_test(eQTL_results_Liver_Ribo_RNA_resid, ids_unknown[start:end], local_sdps)
save(locals_unknowns, file =  paste(dir, "20180403_Liver_Ribo_RNA_resid/unknowns_", counter, ".RData", sep=""))
