...
dir="RatHeartTranslatome/results/QTL_mapping/Result_tables/"
...
load(file="RatHeartTranslatome/results/QTL_mapping/Result_tables/local_sdps.RData")
...
locals_unknowns = QTL_cat_test(eQTL_results_Liver_Ribo, ids_unknown[start:end], local_sdps)
save(locals_unknowns, file =  paste(dir, "20180213_Liver_Ribo/unknowns_", counter, ".RData", sep=""))
