...
ibs = read.table("Desktop/ibs_all.txt", sep="\t", header=T)
...
ev = eigen(as.matrix(ibs[,2:31]))
ibs.vectors <- ev$vectors

covar_ibs = t(data.frame(id = colnames(ibs[,2:31]), ibs.vectors[,1:10]))
write.table(covar_ibs, file = paste(res_dir, "Input/covariates_ibs.txt", sep=""), sep="\t", col.names = F, row.names=T, quote = F)
#polyA lv

### define input
phenotype.file = paste(res_dir, "Input/Lv_polyA/phenotypes.txt", sep="")
genotypes.file =  paste(res_dir, "Input/sdp_genotypes.txt", sep="")
covariates.file =  paste(res_dir, "Input/covariates_ibs.txt", sep="")
...
pheno=log2_polyA_lv
covariates=covar_ibs
genes = genes_filtered_lv 
save(pheno, covariates, positions, snp.pos, genes, genotypes_alleles, genotypes_alleles, phenotype.file, genotypes.file, covariates.file,snps_location_file_name, gene_location_file_name, file = paste(res_dir, "Input/Lv_polyA/Lv_polyA_input_ibs.RData", sep=""))
...
save(pheno, covariates, positions, snp.pos, genes, genotypes_alleles, phenotype.file, genotypes.file, covariates.file,snps_location_file_name, gene_location_file_name, file = paste(res_dir, "Input/Liver_polyA/Liver_polyA_input_ibs.RData", sep=""))
...
covariates=covar_ibs
genes = genes_filtered_lv 
save(pheno, covariates, positions, snp.pos, genes, genotypes_alleles, phenotype.file, genotypes.file, covariates.file,snps_location_file_name, gene_location_file_name, file = paste(res_dir, "Input/Lv_Ribo/Lv_ribo_input_ibs.RData", sep=""))
...
covariates=covar_ibs
genes = genes_filtered_li 
save(pheno, covariates, positions, snp.pos, genes, genotypes_alleles, phenotype.file, genotypes.file, covariates.file,snps_location_file_name, gene_location_file_name, file = paste(res_dir, "Input/Liver_Ribo/Liver_ribo_input_ibs.RData", sep=""))


#compute eQTLs
load(paste(res_dir, "Input/Lv_polyA/Lv_polyA_input_ibs.RData", sep=""))
actual.eqtls = eqtl_new(phenotype.file, genotypes.file, covariates.file, positions, snp.pos, paste(res_dir, "Result_tables/20201105_Lv_polyA_ibs/Lv_polyA", sep=""), compute.all=T, only_cis=F)
save(actual.eqtls, file = paste(res_dir, "Result_tables/20201105_Lv_polyA_ibs/eqtls.RData", sep=""))

load(paste(res_dir, "Input/Liver_polyA/Liver_polyA_input_ibs.RData", sep=""))
actual.eqtls = eqtl_new(phenotype.file, genotypes.file, covariates.file, positions, snp.pos, paste(res_dir, "Result_tables/20201105_Liver_polyA_ibs/Liver_polyA", sep=""), compute.all=T, only_cis=F)
save(actual.eqtls, file=paste(res_dir, "Result_tables/20201105_Liver_polyA_ibs/eqtls.RData", sep=""))

load(paste(res_dir, "Input/Lv_Ribo/Lv_ribo_input_ibs.RData", sep=""))
actual.eqtls = eqtl_new(phenotype.file, genotypes.file, covariates.file, positions, snp.pos, paste(res_dir, "Result_tables/20201105_Lv_Ribo_ibs/Lv_ribo", sep=""), compute.all=T, only_cis=F)
save(actual.eqtls, file=paste(res_dir, "Result_tables/20201105_Lv_Ribo_ibs/eqtls.RData", sep=""))

load(paste(res_dir, "Input/Liver_Ribo/Liver_ribo_input.RData", sep=""))
actual.eqtls = eqtl_new(phenotype.file, genotypes.file, covariates.file, positions, snp.pos, paste(res_dir, "Result_tables/20201105_Liver_Ribo_ibs/Liver_ribo", sep=""), compute.all=T, only_cis=F)
save(actual.eqtls, file=paste(res_dir, "Result_tables/20201105_Liver_Ribo_ibs/eqtls.RData", sep=""))
...
covariates=covar_ibs
genes = genes_filtered_lv 
save(pheno, covariates, positions, snp.pos, genes, genotypes_alleles, genotypes_alleles, phenotype.file, genotypes.file, covariates.file,snps_location_file_name, gene_location_file_name, file = paste(res_dir, "Input/Lv_Ribo_RNA_resid/Lv_Ribo_RNA_resid_input_ibs.RData", sep=""))


load(paste(res_dir, "Input/Lv_Ribo_RNA_resid/Lv_Ribo_RNA_resid_input_ibs.RData", sep=""))
actual.eqtls = eqtl_new(phenotype.file, genotypes.file, covariates.file, positions, snp.pos, paste(res_dir, "Result_tables/20201107_Lv_Ribo_RNA_resid_ibs/Lv_Ribo_RNA_resid_", sep=""), compute.all=T, only_cis=F)
save(actual.eqtls, file=paste(res_dir, "Result_tables/20201107_Lv_Ribo_RNA_resid_ibs/eqtls.RData", sep=""))
