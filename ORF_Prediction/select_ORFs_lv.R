...
setwd("RiboTaper/results/pooled_all_lv/")


files<-list.files(pattern="ORFs_max",all.files=T,path="RiboTaper/results/lv/results",include.dirs=F,recursive=T,full.names=T)
